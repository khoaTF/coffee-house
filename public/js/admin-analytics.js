...
// =============================================
// 7D — ABC ANALYSIS (Best Sellers vs Dead Stock)
// =============================================
function renderABCAnalysis(startDate, endDate) {
    ...
    tbody.innerHTML = '';
    if (sorted.length === 0) {
        tbody.innerHTML = '<tr><td colspan="5" class="text-center py-4 text-slate-500">Chưa có dữ liệu trong khoảng thời gian này.</td></tr>';
        return;
    }
...
function renderCustomerRetention(startDate, endDate) {
    ...
    // Phân tích toàn bộ order history
    // Lấy những người có SĐT
